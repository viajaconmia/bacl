...
router.get("/allowed", controller.obtenerHotelesPrioridad);
...
router.get(
  "/Consultar-precio-sencilla/:id_hotel",
  controller.consultaPrecioSencilla,
);
...
router.get(
  "/Consultar-tarifas-por-hotel/:id_hotel",
  controller.getTarifasByIdHotel,
);
router.get("/Paginacion", controller.paginacion);
router.get("/Consulta-Hoteles-por-termino", controller.BuscaHotelesPorTermino);
router.get(
  "/Filtra-hotel-tarifas-por-nombre",
  controller.get_hotel_tarifas_by_nombre,
);
