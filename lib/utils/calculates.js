...
class Calculo {
  ...
  const result = cambian_noches === 1 ? {cambian_noches,delta_noches}: {cambian_noches}; 
  return result;
  }
  ...
  const result = cambia_precio_de_venta === 1 ? {cambia_precio_de_venta,delta_precio_venta}: {cambia_precio_de_venta};
  return result;
  }
}
